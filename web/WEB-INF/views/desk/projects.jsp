        ...
        <div role="navigation" class="navbar navbar-default">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="/" class="navbar-brand scroll-to">StockManager</a>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="finishDate" type="date" name="finishDate" class="form-control"
                                               placeholder="yyyy-mm-dd">
                                    </div>
                                </div>
                            </div>
                    ...
                    <tr>
                        <form name="stateProjectForm" action="desk/updateStateProject" method="GET">
                            ...
                            <td class="text-center"><input type="text" name="userId" value=
                                <c:out value="${project.userId}"/> size="2"></td>
                            <td class="text-center">
